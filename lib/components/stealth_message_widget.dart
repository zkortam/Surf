...
class _StealthMessageWidgetState extends State<StealthMessageWidget> {
  late StealthMessageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StealthMessageModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'jjky83x8' /* Stealth Mode allows for anonym... */,
                          ),
